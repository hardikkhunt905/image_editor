...
class DraggableStickers extends StatefulWidget {
  ...
  final List<Sticker>? stickerList;// ignore: use_key_in_widget_constructors
...
class _DraggableStickersState extends State<DraggableStickers> {
  ...
  @override
  Widget build(BuildContext context) => stickers.isNotEmpty && stickers != []
        ? Stack(
            fit: StackFit.expand,
            children: [
              Positioned.fill(
              ...
              for (final sticker in stickers)
                ...
                DraggableResizable(
                  ...
                  // Size of the sticker
                  size: sticker.sizes != null ? sticker.sizes! : (sticker.isText == true
