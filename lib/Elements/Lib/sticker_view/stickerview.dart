...
class StickerView extends StatefulWidget {
  ...
  const StickerView({this.stickerList, this.height, this.width, this.bgImage, this.sizes, });
...
class StickerViewState extends State<StickerView> {
  ...
  @override
  Widget build(BuildContext context) => stickerList != null
        ? Stack(
            children: [
              ...
              RepaintBoundary(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    image: widget.bgImage != null ? DecorationImage(fit: BoxFit.cover,image: FileImage(File(widget.bgImage!))) : null,
...
class Sticker extends StatefulWidget {
  ...
  String id;
  Sticker({super.key, this.child, this.isText, required this.id,this.sizes,this.position});
  @override
